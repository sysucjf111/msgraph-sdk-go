...
// NewRiskyServicePrincipalsCountRequestBuilderInternal instantiates a new RiskyServicePrincipalsCountRequestBuilder and sets the default values.
func NewRiskyServicePrincipalsCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*RiskyServicePrincipalsCountRequestBuilder) {
    m := &RiskyServicePrincipalsCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/identityProtection/riskyServicePrincipals/$count{?%24filter,%24search}", pathParameters),
    }
    return m
}
// NewRiskyServicePrincipalsCountRequestBuilder instantiates a new RiskyServicePrincipalsCountRequestBuilder and sets the default values.
...
func (m *RiskyServicePrincipalsCountRequestBuilder) WithUrl(rawUrl string)(*RiskyServicePrincipalsCountRequestBuilder) {
    return NewRiskyServicePrincipalsCountRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
